...
channels = _guilds.get_collection('channels', read_preference=pymongo.ReadPreference.SECONDARY)
messages = _guilds.get_collection('messages', read_preference=pymongo.ReadPreference.SECONDARY)
roles = _guilds.get_collection('roles', read_preference=pymongo.ReadPreference.SECONDARY)
